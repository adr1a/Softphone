...
public class Transmitter implements Runnable{
	...
	public void iniciaAudio()
	{
		...
		AV2 = new AVTransmit(MyApp,audioMediaLocator,peerIp, miIP,tpA,recA,captureAudioFormat);
	...
	public void iniciaVideo()
	{
		...
		AV = new AVTransmit(MyApp,videoMediaLocator,peerIp,miIP,tpV,recV,captureVideoFormat);
